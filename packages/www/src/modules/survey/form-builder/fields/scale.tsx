...
export function FieldScale($: SurveyFieldProps<'scale'>) {
      ...
      <For each={$.formField.options}>
        {option => (
          <RadioGroup.Item
            ...
            class='flex focus-within:ring-2 focus-within:ring-accent-500 py-3 px-2 items-center group hover:bg-gray-100 transition rounded-md'
          >
